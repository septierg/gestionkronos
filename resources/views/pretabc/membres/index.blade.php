                ...
                <div class="card" style="background-color: rgba(0,0,0,0.08);">
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-40">
                            ...
                            {!! Form::open(['action' => 'PretabcMembreController@index','method' => 'GET', 'class'=> 'search']) !!}
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($membre->path_permis_conduire)
                                    <a href="{!! url("https://pretabc.com/{$membre->path_permis_conduire}") !!}" style="color:green;"><button type="button" class="btn btn-success btn-circle" id="sa-documents-1">PC</button></a>
                                @else
                                ...
                                @if($membre->path_talon_paie)
                                    <a href="{!! url("https://pretabc.com/{$membre->path_talon_paie}") !!}" style="color:green;"><button type="button" class="btn btn-success btn-circle" id="sa-documents-1">TP</button> </a>
                                @else
                                ...
                                @if($membre->path_specimen_cheque)
                                    <a href="{!! url("https://pretabc.com/{$membre->path_specimen_cheque}") !!} " style="color:green;"><button type="button" class="btn btn-success btn-circle" id="sa-documents-1">SC</button> </a>
                                @else
                                    <button type="button" class="btn btn-danger btn-circle" id="sa-documents-3">SC</button>
                                @endif

                                @if($membre->path_releve_bancaire)
                                    <a href="{!! url("https://pretabc.com/{$membre->path_releve_bancaire}") !!}" style="color:green;"> <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">RB</button></a>
                                @else
                                ...
                                @if($membre->path_preuve_residence)
                                    <a href="{!! url("https://pretabc.com/{$membre->path_preuve_residence}") !!}" style="color:green;"> <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">PR</button></a>
                                @else
                                    <button type="button" class="btn btn-danger btn-circle" id="sa-documents-3">PR </button>
                                @endif
                            </td>
                            <td><a href="{{ route('membre.edit', $membre->id_demandeur) }}"> <button type="button" class="btn btn-dark btn-circle"><i class="fa fa-edit"></i> </button></a>
                                <a href="{{ route('membre_email', $membre->id_demandeur) }}"><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-envelope"></i> </button></a>
                                <a href="{{ route('membre_contrat', $membre->id_demandeur) }}"><button type="button" class="btn btn-warning btn-circle" style="background-color:green;border-color: green"> <i class="fa fa-envelope" ></i> </button></a>
