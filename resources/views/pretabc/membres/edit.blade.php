    ...
    <div class="container-fluid">
        <div class="row page-titles" style="position: relative;top: -43px; ">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    {!! Form::model($membres, ['method' => 'PATCH','action' => ['PretabcMembreController@update', $membres->id_demandeur],'files' =>true]) !!}

                    <button class="btn btn-info d-none d-lg-block m-l-15" ><a href="https://pretabc.com/moncompte.php?admin={{ $_SESSION["admin"]}}&id={{ $membres->id_demandeur }}"  style="color:white;"><i class="fa fa-plus-circle"></i> Voir les contrats et informations de ce client</a></button>
        ...
        <div class="container-fluid" style="padding-bottom:15px;">
            ...
            <h4>Informations personnelles</h4>
                        ...
                        <img src="../../images/icon_pretabc.png"  style="width:35px; margin:15px;" alt="pretabc" class=""><br>
        ...
        <div class="container-fluid" style="padding-bottom:15px;">
            <div class="row" style="background-color:white">
                <div class="col-12" style="padding-top:10px;">
                    <div class="card">
                        <h4>Prêt en cours</h4>
                        {!! Form::model($membres, ['method' => 'PATCH','action' => ['PretabcPretController@show', $membres->id],'files' =>true]) !!}
                        ...
                        <button class="w3-blue-grey"><a href="{{route('pretabc.edit', $membres->id) }}" style="color:white">Voir le pret en cours</a></button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" style="background-color:white">
                ...
                <div class="col-6" style="padding-top:10px;">
                    <div class="card">
                        ...
                        <div class="form-group">
                            {!! Form::label('title', '1750$',['class'=> 'margin']) !!}

                            <input id="" name="montant_m8" value="<?= $mm_matrice[7] ?>" type="number" step="0.01" class="form-control">

                        </div>
                        <div class="form-group">
                            {!! Form::label('title', '2000$',['class'=> 'margin']) !!}

                            <input id="" name="montant_m9" value="<?= $mm_matrice[8] ?>" type="number" step="0.01" class="form-control">

                        </div>
                        <div class="form-group">
                            {!! Form::label('title', '2250$',['class'=> 'margin']) !!}

                            <input id="" name="montant_m10" value="<?= $mm_matrice[9] ?>" type="number" step="0.01" class="form-control">

                        </div>

                        <div class="form-group">
                            {!! Form::label('title', '2500$',['class'=> 'margin']) !!}

                            <input id="" name="montant_m11" value="<?php if(count($mm_matrice) == 11)
                            {
                                echo $mm_matrice[10];
                            }
                            else
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td style="text-align: center!important;">
                                                <a href="{{url('https://pretabc.com/'.$membres->path_permis_conduire)}}">
                                        ...
                                        <tr>
                                            <td style="text-align: center!important;">
                                                <a href="{{url('https://pretabc.com/'.$membres->path_releve_bancaire)}}">
                                                    <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">
                                                        <i class="fa fa-id-card"></i>
                                                    </button>
                                                </a>
                                        ...
                                        <tr>
                                            <td style="text-align: center!important;">
                                                <a href="{{url('https://pretabc.com/'.$membres->path_specimen_cheque)}}">
                                                    <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">
                                                        <i class="fa fa-id-card"></i>
                                                    </button>
                                                </a>
                                        ...
                                        <tr>
                                            <td style="text-align: center!important;">
                                                <a href="{{url('https://pretabc.com/'.$membres->path_talon_paie)}}">
                                                    <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">
                                                        <i class="fa fa-id-card"></i>
                                                    </button>
                                                </a>
                                        ...
                                        <tr>
                                            <td style="text-align: center!important;">
                                                <a href="{{url('https://pretabc.com/'.$membres->path_preuve_residence)}}">
                                                    <button type="button" class="btn btn-success btn-circle" id="sa-documents-1">
                                                        <i class="fa fa-id-card"></i>
                                                    </button>
                                                </a>
