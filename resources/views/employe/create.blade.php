    ...
    <div class="container-fluid" style="margin-top:-44px;">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-white">Ajouter un employé</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['action' => 'EmployesController@store','method' => 'POST','files' =>true]) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 nopadding">
                                        ...
                                        <div class="col-md-12">
                                            {!! Form::text('name', null,array_merge(['class' => 'form-control text-muted']))!!}
                                        </div>
                                    </div>
                                    <div class="col-md-6 nopadding">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('email', null,array_merge(['class' => 'form-control text-muted']))!!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('password', null,array_merge(['class' => 'form-control text-muted']))!!}
                                </div>
                            </div>
                        </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    {!! Form::select('role_id', ['1' => 'Niveau d\' accès 1(Administrateur)', '2' => 'Niveau d\' accès 2(Employe)'], null, array_merge(['class' => 'form-control text-muted','placeholder' => 'Selectionner un niveau d\'accès']));!!}
