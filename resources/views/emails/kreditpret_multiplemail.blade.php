...
<table bgcolor='#FFFFFF' cellpadding='0' cellspacing='0' class='nl-container' role='presentation' style='table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; width: 100%;' valign='top' width='100%'>
                        ...
                        <div class='col num6' style='min-width: 320px; max-width: 350px; display: table-cell; vertical-align: top;;'>
                            <div style='width:100% !important;'>
                                ...
                                <div style='border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;'>
                                    ...
                                    <p style='font-size: 14px; line-height: 14px; text-align: right; margin: 0;'><span style='font-size: 12px;'></span></p>
                                </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            <!--[if (!mso)&(!IE)]><!-->
                        ...
                        <div class='col num12' style='min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top;;'>
                            <div style='width:100% !important;'>
                                ...
                                <div style='border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;'>
                                    ...
                                    <br><br>
                                    <p style='font-size: 14px; line-height: 16px; margin: 0;'><strong><span style='font-size: 46px; line-height: 55px;'>Bonjour, <span style='color: #4cade9; line-height: 55px; font-size: 46px;'>{{ $nom  }}</span>!</span></strong></p>
                                </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <p style='font-size: 12px; line-height: 18px; margin: 0;'><strong><span style='font-size: 20px; line-height: 30px;'>
    <br>
    ...
    <br><br>
    Vous devez vous rendre dans ‘’ Mon compte ‘’ sur le site   <a href="https://www.kreditpret.com">web</a>  et être sûr que les conditions suivantes sont respectées.
    <br><br>
    Pour déposer un document dans la section ‘’document’', suivez les instructions à l'écran.
    <br><br>
    1- Votre permis de conduire. On a besoin d'une pièce d'identité valide avec photo du gouvernement, vous pouvez aussi soumettre votre carte d'assurance maladie. Le document doit être dans l’onglet: permis de conduire.
    <br>
    2- Votre IBV. Nous avons besoin de voir 90 jours consécutifs de transactions les plus récentes de votre compte-chèque. La IBV est la première étape lorsque vous rentrez dans votre profil.
    <br>
    3- Talon de paie. Nous avons besoin de votre talon de paie le plus récent. Le document doit être dans l’onglet: talon de paie.
    <br>
    4- Votre ratio d’endettement. Vous devez remplir les informations concernant votre ratio d’endettement. Les informations doivent être dans l’onglet profil section '' ratio d’endettement ''.
    <br>
    5- Les informations concernant votre employeur et votre personne de référence dans la section profil.
    <br><br>
    Veuillez soumettre le tout dans votre profil sur le site web de  <a href="https://www.kreditpret.com">kreditpret</a> pour qu'on puisse continuer l'analyse de votre demande.
    <br><br>
    Merci,<br>
    Équipe de Kredit Prêt<br>
    **********************************************************
    <br><br>
    We successfully received your request. However, one or more documents or steps below is needed to complete your request.
    <br><br>
    You must go to ‘’ My Account ‘’ on the  <a href="https://kreditpret.com/en/payday-loan.php">website</a> and be sure that the following conditions are done.  <br><br>
    ...
    <br><br>
    Please submit every of those points in your profile on the <a href="https://kreditpret.com/en/payday-loan.php">kreditpret</a> website so we can continue to analyze your application.
     <br><br>
     Thank you,<br>
     Team  Kredit Prêt <br>
                            ...
                            <div style='width:100% !important;'>
                                ...
                                <div style='border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:25px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;'>
                                    ...
                                    <div align='center' class='button-container' style='padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;'>
                                        ...
                                        <!--
                                        <div style='text-decoration:none;display:inline-block;color:#ffffff;background-color:#4cade9;border-radius:9px;-webkit-border-radius:9px;-moz-border-radius:9px;width:auto; width:auto;;border-top:1px solid #4cade9;border-right:1px solid #4cade9;border-bottom:1px solid #4cade9;border-left:1px solid #4cade9;padding-top:10px;padding-bottom:10px;font-family:'Open Sans', Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;'>
                        ...
                        <div class='col num12' style='min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top;;'>
                            <div style='width:100% !important;'>
                                ...
                                <div style='border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:15px; padding-bottom:35px; padding-right: 0px; padding-left: 0px;'>
                                    ...
                                    <p style='font-size: 14px; line-height: 21px; text-align: center; margin: 0;'><span style='color: #000000; font-size: 14px; line-height: 21px;'><strong>Kredit Prêt</strong></span></p>
