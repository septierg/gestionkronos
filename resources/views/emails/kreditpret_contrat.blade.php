...
<table bgcolor='#FFFFFF' cellpadding='0' cellspacing='0' class='nl-container' role='presentation' style='table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; width: 100%;' valign='top' width='100%'>
 ...
 <br>
    An English message will follow <br><br>

    Veuillez s'il-vous-plait accepter les 3 contrats légaux pour votre demande de prêt.
    <br><br>
    Vous devez vous rendre dans ‘’ mon compte ‘’ sur le site <a href="https://www.kreditpret.com">web</a>  et cliquez sur l’onglet ‘’mon contrat’’. Prenez le temps de lire les contrats avant de les signer.
    <br><br>
    Merci,<br>
    ...
    **********************************************************
    ...
    Go on ‘’ my account ‘’ section on the <a href="https://kreditpret.com/en/payday-loan.php">website</a>  and then click on ‘’my contract‘’ tab. Take the time you need to read the contracts before signing them.
    <br><br>
    Thank you,<br>
    Team Kredit Prêt<br>
