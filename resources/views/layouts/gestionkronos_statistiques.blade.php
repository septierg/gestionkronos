        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile">
                <div class="user-pro-body">
                    ...
                    <div class="dropdown">
                        <a href=""class="u-dropdown link hide-menu" role="button" aria-expanded="false" style="color:#fff!important;">{{ Auth::user()->name }}<br>Administrateur</a>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{ route('demande.index') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Voir toutes les demandes</a>
                    </div>
                </div>
            </div>
