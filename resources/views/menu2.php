          ...
          <div class="rd-navbar-panel">
            ...
            <div class="rd-navbar-brand">
              ...
              <a class="brand" href="index.php">
                <img class="brand-logo-dark" src="images/logo-default2-242x88.png" alt="" width="121" height="44" style="transform: scale(2.5);margin-left: 80px;margin-right: 60px;"/>
            ...
            <div class="rd-navbar-main-element">
              <div class="rd-navbar-nav-wrap">
                <ul class="rd-navbar-nav">
                  ...
                  <li class="rd-nav-item active"><a class="rd-nav-link" href="notre-entreprise.php">Notre entreprise</a></li>
